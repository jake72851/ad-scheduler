...
const basic = require('../controllers/tiktok/insight/basicCampaign');
const audience = require('../controllers/tiktok/insight/audienceCampaign');
const DSA = require('../controllers/tiktok/insight/DSACampaign');
const reservation = require('../controllers/tiktok/insight/reservationCampaign');
