...
const basic = require('../controllers/tiktok/insight/basicAdaccount');
const audience = require('../controllers/tiktok/insight/audienceAdaccount');
const DSA = require('../controllers/tiktok/insight/DSAAdaccount');
const reservation = require('../controllers/tiktok/insight/reservationAdaccount');
