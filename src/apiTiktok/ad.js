...
const basic = require('../controllers/tiktok/insight/basicAd');
const audience = require('../controllers/tiktok/insight/audienceAd');
const DSA = require('../controllers/tiktok/insight/DSAAd');
const reservation = require('../controllers/tiktok/insight/reservationAd');
