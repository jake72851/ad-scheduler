...
exports.request = async function (userId, advertiserIds, advertiserName, termDay, dimensionAdd) {
  ...
  // console.log('adGroups DSA 인사이트 result =', result);

  const dimensionJoin = dimensionAdd.join(', ');

  if (result.data.message !== 'OK') {
    console.log('adGroups DSA ' + dimensionJoin + ' 인사이트 err =', result.data.message);
  } else {
    console.log('adGroups DSA ' + dimensionJoin + ' 인사이트 result page_info =', result.data.data.page_info);
    // console.log('adGroups DSA ' + dimensionJoin + ' 인사이트 result list =', result.data.data.list);
    console.log('adGroups DSA ' + dimensionJoin + ' 인사이트 result list.length =', result.data.data.list.length);
    ...
    // console.log('arr =', arr);
    console.log('adGroups DSA ', dimensionJoin, ' arr.length =', arr.length);
