...
exports.request = async function (userId, advertiserIds, advertiserName, termDay, dimensionAdd) {
  ...
  // console.log('광고계정 DSA 인사이트 result =', result);

  const dimensionJoin = dimensionAdd.join(', ');

  if (result.data.message !== 'OK') {
    console.log('광고계정 DSA ' + dimensionJoin + ' 인사이트 err =', result.data.message);
  } else {
    console.log('광고계정 DSA ' + dimensionJoin + ' 인사이트 result page_info =', result.data.data.page_info);
    // console.log('광고계정 DSA ' + dimensionJoin + ' 인사이트 result list =', result.data.data.list);
    console.log('광고계정 DSA ' + dimensionJoin + ' 인사이트 result list.length =', result.data.data.list.length);
    ...
    // console.log('arr =', arr);
    console.log('광고계정 DSA ', dimensionJoin, ' arr.length =', arr.length);
