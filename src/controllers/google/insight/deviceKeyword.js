...
exports.request = async function (accessToken, userId, customerId, customerName, termDay) {
  ...
  // console.log('keyword_view device =', result.data.results);
...
keyword_view device = [
  {
    ...
    metrics: {
      ...
      searchRankLostAbsoluteTopImpressionShare: 0.016722408026755852,
      searchRankLostImpressionShare: 0.006688963210702341,
      searchRankLostTopImpressionShare: 0.013377926421404682,
      searchTopImpressionShare: 0.0999,
      topImpressionPercentage: 0.25,
      videoViews: '0',
    ...
    adGroupCriterion: {
      resourceName: 'customers/5318998392/adGroupCriteria/144839605837~414241133',
      status: 'ENABLED',
      qualityInfo: [Object],
    ...
    keywordView: {
      resourceName: 'customers/5318998392/keywordViews/144839605837~414241133'
    },
