...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionGoogleAdsCampaign =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionGoogleAdsCampaign =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'sessionGoogleAdsCampaign',
    ...
    console.log('GA4 sessionGoogleAdsCampaign = 없어요');
    // return null;
  }
};
