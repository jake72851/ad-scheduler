...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 googleAdsAdNetworkType =', result.data);
  ...
  if (
    ...
    // console.log('GA4 googleAdsAdNetworkType =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'googleAdsAdNetworkType',
    ...
    console.log('GA4 googleAdsAdNetworkType = 없어요');
    // return null;
  }
};
