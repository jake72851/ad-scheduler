...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 googleAdsAdCampaign =', result.data);
  ...
  if (
    ...
    // console.log('GA4 googleAdsAdCampaign =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'googleAdsAdCampaign',
    ...
    console.log('GA4 googleAdsAdCampaign = 없어요');
    // return null;
  }
};
