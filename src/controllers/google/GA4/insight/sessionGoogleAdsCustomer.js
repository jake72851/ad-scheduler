...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionGoogleAdsCustomer =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionGoogleAdsCustomer =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'sessionGoogleAdsCustomer',
    ...
    console.log('GA4 sessionGoogleAdsCustomer = 없어요');
    // return null;
  }
};
