...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 firstUserCampaign =', result.data);
  ...
  if (
    ...
    // console.log('GA4 firstUserCampaign =', result.data.reports);
    ...
    console.log('GA4 firstUserCampaign = 없어요');
    // return null;
  }
};
