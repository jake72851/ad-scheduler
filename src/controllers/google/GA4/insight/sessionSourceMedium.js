...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionSourceMedium =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionSourceMedium =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'sessionSourceMedium',
    ...
    console.log('GA4 sessionSourceMedium = 없어요');
    // return null;
  }
};
