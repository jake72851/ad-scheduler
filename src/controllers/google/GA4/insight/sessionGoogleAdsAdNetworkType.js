...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionGoogleAdsAdNetworkType =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionGoogleAdsAdNetworkType =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'sessionGoogleAdsAdNetworkType',
    ...
    console.log('GA4 sessionGoogleAdsAdNetworkType = 없어요');
    // return null;
  }
};
