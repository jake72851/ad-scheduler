...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionGoogleAdsAdGroup =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionGoogleAdsAdGroup =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'sessionGoogleAdsAdGroup',
    ...
    console.log('GA4 sessionGoogleAdsAdGroup = 없어요');
    // return null;
  }
};
