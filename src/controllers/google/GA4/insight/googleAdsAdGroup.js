...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 googleAdsAdGroup =', result.data);
  ...
  if (
    ...
    // console.log('GA4 googleAdsAdGroup =', result.data.reports);
    ...
    console.log('GA4 googleAdsAdGroup = 없어요');
    // return null;
  }
};
