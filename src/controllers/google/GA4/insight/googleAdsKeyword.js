...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 googleAdsKeyword =', result.data);
  ...
  if (
    ...
    // console.log('GA4 googleAdsKeyword =', result.data.reports);
    ...
    console.log('GA4 googleAdsKeyword = 없어요');
    // return null;
  }
};
