...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionCampaign =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionCampaign =', result.data.reports);
    ...
    console.log('GA4 sessionCampaign = 없어요');
    // return null;
  }
};
