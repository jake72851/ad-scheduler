...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 firstUserSourceMedium =', result.data);
  ...
  if (
    ...
    // console.log('GA4 firstUserSourceMedium =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'firstUserSourceMedium',
    ...
    console.log('GA4 firstUserSourceMedium = 없어요');
    // return null;
  }
};
