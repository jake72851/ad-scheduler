...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionGoogleAdsCreative =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionGoogleAdsCreative =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'sessionGoogleAdsCreative',
    ...
    console.log('GA4 sessionGoogleAdsCreative = 없어요');
    // return null;
  }
};
