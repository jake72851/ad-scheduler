...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionGoogleAdsAccountName =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionGoogleAdsAccountName =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'sessionGoogleAdsAccountName',
    ...
    console.log('GA4 sessionGoogleAdsAccountName = 없어요');
    // return null;
  }
};
