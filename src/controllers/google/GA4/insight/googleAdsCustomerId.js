...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 googleAdsCustomerId =', result.data);
  ...
  if (
    ...
    // console.log('GA4 googleAdsCustomerId =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'googleAdsCustomerId',
    ...
    console.log('GA4 googleAdsCustomerId = 없어요');
    // return null;
  }
};
