...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 googleAdsCreativeId =', result.data);
  ...
  if (
    ...
    // console.log('GA4 googleAdsCreativeId =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'googleAdsCreativeId',
    ...
    console.log('GA4 googleAdsCreativeId = 없어요');
    // return null;
  }
};
