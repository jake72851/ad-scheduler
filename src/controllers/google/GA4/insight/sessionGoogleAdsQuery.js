...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionGoogleAdsQuery =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionGoogleAdsQuery =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'sessionGoogleAdsQuery',
    ...
    console.log('GA4 sessionGoogleAdsQuery = 없어요');
    // return null;
  }
};
