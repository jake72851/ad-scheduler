...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionDefaultChannelGroup =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionDefaultChannelGroup =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'sessionDefaultChannelGroup',
    ...
    console.log('GA4 sessionDefaultChannelGroup = 없어요');
    // return null;
  }
};
