...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 sessionGoogleAdsKeyword =', result.data);
  ...
  if (
    ...
    // console.log('GA4 sessionGoogleAdsKeyword =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'sessionGoogleAdsKeyword',
    ...
    console.log('GA4 sessionGoogleAdsKeyword = 없어요');
    // return null;
  }
};
