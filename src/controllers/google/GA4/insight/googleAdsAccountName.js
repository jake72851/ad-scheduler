...
exports.request = async function (accessToken, userId, GA4Id, termDay, accountId, accountName) {
  ...
  // console.log('GA4 googleAdsAccountName =', result.data);
  ...
  if (
    ...
    // console.log('GA4 googleAdsAccountName =', result.data.reports);
    ...
    const data = {
      ...
      GA4Id,
      breakdowns: 'googleAdsAccountName',
    ...
    console.log('GA4 googleAdsAccountName = 없어요');
    // return null;
  }
};
