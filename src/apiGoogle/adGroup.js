...
const deviceInsight = require('../controllers/google/insight/deviceAdGroup');
const ageInsight = require('../controllers/google/insight/ageAdGroup');
const genderInsight = require('../controllers/google/insight/genderAdGroup');
const geoInsight = require('../controllers/google/insight/geoAdGroup');
const biddingStrategyInsight = require('../controllers/google/insight/biddingStrategyAdGroup');
const resultInsight = require('../controllers/google/insight/resultAdGroup');
