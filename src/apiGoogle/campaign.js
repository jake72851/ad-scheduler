...
const deviceInsight = require('../controllers/google/insight/deviceCampaign');
const ageInsight = require('../controllers/google/insight/ageCampaign');
const genderInsight = require('../controllers/google/insight/genderCampaign');
const geoInsight = require('../controllers/google/insight/geoCampaign');
const biddingStrategyInsight = require('../controllers/google/insight/biddingStrategyCampaign');
const resultInsight = require('../controllers/google/insight/resultCampaign');
const budget = require('../controllers/google/insight/budgetCampaign');
...
// console.log('campaign =', result.data.results);
/*
  campaign = [
    {
      customer: {
      ...
      metrics: {
        ...
        allConversionsFromMenu: 0,
        allConversionsFromOrder: 0,
        allConversionsFromOtherEngagement: 0,
        allConversionsFromStoreVisit: 0,
        allConversionsFromStoreWebsite: 0,
        gmailForwards: '0',
        gmailSaves: '0',
