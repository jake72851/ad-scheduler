...
const deviceInsight = require('../controllers/google/insight/deviceAd');
...
// const biddingStrategyInsight = require('../controllers/googleBiddingStrategyInsight_ad');
const resultInsight = require('../controllers/google/insight/resultAd');
...
exports.request = async function (accessToken, userId, customerId, customerName, termDay) {
  ...
  // console.log('ads =', result.data.results);
...
ads = [
  {
    ...
    adGroupAd: {
      resourceName: 'customers/5318998392/adGroupAds/119121218154~490928645234',
      status: 'ENABLED',
      ad: [Object],
      policySummary: [Object],
      adGroup: 'customers/5318998392/adGroups/119121218154'
    }
  },
]
*/
